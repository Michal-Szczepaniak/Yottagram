...
Core::Core(QObject *parent) : QObject(parent)
{
    ...
    connect(&_authorization, &Authorization::isAuthorizedChanged, [this](bool isAuthorized) { if (isAuthorized) _wifiAutoDownloadSettings.loadSettings(); });
    ...
    connect(&_authorization, &Authorization::isAuthorizedChanged, [this](bool isAuthorized) { if (isAuthorized) _mobileAutoDownloadSettings.loadSettings(); });
    ...
    connect(&_authorization, &Authorization::isAuthorizedChanged, [this](bool isAuthorized) { if (isAuthorized) _roamingAutoDownloadSettings.loadSettings(); });
    ...
    connect(&_authorization, &Authorization::isAuthorizedChanged, [this](bool isAuthorized) { if (isAuthorized) _otherAutoDownloadSettings.loadSettings(); });
