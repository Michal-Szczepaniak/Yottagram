...
void TelegramManager::messageReceived(uint64_t id, td_api::Object* message)
{
    ...
    downcast_call(
        *message, overloaded(
            ...
            [this](td_api::updateChatMessageAutoDeleteTime &updateChatMessageAutoDeleteTime) { emit this->updateChatMessageAutoDeleteTime(&updateChatMessageAutoDeleteTime); },
            [this](td_api::updateChatFolders &updateChatFolders) { emit this->updateChatFolders(&updateChatFolders); },
            ...
            [this](td_api::updateForumTopic &updateForumTopic) { emit this->updateForumTopic(&updateForumTopic); },
