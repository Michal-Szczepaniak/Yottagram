...
Page {
    ...
    ConfigurationGroup {
        ...
        property bool superGroupNotificationSettingsHintShown: false
        Component.onCompleted: if (!superGroupNotificationSettingsHintShown) hint.start()
    }
            ...
            Column {
                ...
                TextSwitchWithMenu {
                    ...
                    TapInteractionHint {
                        ...
                        onRunningChanged: if (!running) settings.superGroupNotificationSettingsHintShown = true
                    }
                }
            }
       }
